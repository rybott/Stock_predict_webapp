...
listof_stocks = ['KO','BAC','NVDA','GE','XOM','JNJ','PG','WMT','BA','GS','MCD','AMD','WST']
listof_currencies = ['EUR/USD', 'USD/JPY', 'GBP/USD', 'AUD/USD','USD/BTC','USD/CAD','NZD/USD0','EUR/GBP','GBP/JPY','EUR/JPY']
